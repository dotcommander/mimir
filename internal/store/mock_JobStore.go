...
func (_m *MockJobStore) GetJobByBatchID(ctx context.Context, batchJobID string) (*models.BackgroundJob, error) {
...
func (_m *MockJobStore) ListBatchJobs(ctx context.Context, limit int, offset int) ([]*models.BackgroundJob, error) {
...
func (_m *MockJobStore) RecordBatchAPIInfo(ctx context.Context, jobID uuid.UUID, batchJobID string, inputFileID string) error {
...
func (_m *MockJobStore) RecordJobEnqueue(ctx context.Context, params JobRecordParams) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, JobRecordParams) error); ok {
		r0 = rf(ctx, params)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockJobStore) UpdateJobData(ctx context.Context, jobID uuid.UUID, jobData json.RawMessage) error {
...
func (_m *MockJobStore) UpdateJobStatus(ctx context.Context, jobID uuid.UUID, status string) error {
...
func (_m *MockJobStore) UpdateJobStatusAndOutput(ctx context.Context, batchJobID string, status string, outputFileID string) error {
